...
[StackOverflow](http://stackoverflow.com/questions/ask?tags=angularjs,airwave-ui-router) before reporting it. This
...
A purple label means that **you** need to take some further action.
 ...
 - ![StackOverflow](ngdoc_assets/so.png): We suspect your issue is really a help request, or could be answered by the community.  Please ask your question on [StackOverflow](http://stackoverflow.com/questions/ask?tags=angularjs,airwave-ui-router).  If you determine that is an actual issue, please explain why.
